...
export const LESSONS_ID: Lesson[] = [
  ...
  {
    title: '1. Menulis',
    text: 'Komputer bisa menulis apa saja untukmu. Perintah \'cetak\' menampilkan teks di layar. Coba jalankan, lalu ubah teksnya menjadi kata-katamu sendiri!',
    code: 'cetak("Halo, dunia!")\ncetak("Aku sedang belajar Aksa")\n',
  },
  {
    title: '2. Variabel',
