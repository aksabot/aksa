...
const files = [
	{
		...
		dest: "changelog.md",
		title: "Changelog",
		description: "All notable changes to Aksa.",
		titleId: "Changelog",
		descriptionId: "Semua perubahan penting pada Aksa.",
	...
	},
	{
		...
		titleId: "Roadmap",
		descriptionId: "Apa yang sudah selesai, berikutnya, dan ke mana arah Aksa.",
		stripHeading: /^# Roadmap.*\n+/,
	},
];
